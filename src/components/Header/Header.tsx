          ...
          <Popover
            ...
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                <div className='flex flex-col py-2 pl-2 pr-20'>
                  <button className='px-3 py-1 text-left text-sm hover:text-orange'>
                    Tiếng Việt
                  </button>
                  <button className='mt-2 px-3 py-1 text-left text-sm hover:text-orange'>
                    English
                  </button>
                </div>
              </div>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                {...register('name')}
              />
              <button className='flex-shrink-0 rounded-sm bg-orange px-4 py-1 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='col-span-1 justify-self-end'>
              ...
              renderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchaseInCart ? (
                    ...
                    <div className='flex h-[200px] w-[200px] flex-wrap content-center justify-center'>
                      <img
                        src={noProduct}
                        alt='no purchase'
                        className=' h-28 w-28'
            ...
            >
              <Link to='/' className='relative'>
                ...
                <span className='absolute right-[-8px] top-[-5px] rounded-full bg-white px-[10px] py-[1px] text-xs font-medium text-orange'>
