...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      ...
      return (
        <div className='flex h-screen w-full flex-col items-center justify-center space-x-8 space-y-16 p-16 lg:flex-row lg:space-y-0 2xl:space-x-0'>
          <div className='flex w-full flex-col items-center justify-center text-center lg:w-1/2 lg:px-2 xl:px-0'>
            ...
            <a
              href='/'
              className='flex items-center space-x-2 rounded bg-orange px-4 py-2 text-gray-100 transition duration-150 hover:bg-orange/80'
              title='Return Home'
            >
              <svg
