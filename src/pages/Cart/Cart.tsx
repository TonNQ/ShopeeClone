...
export default function Cart() {
  ...
  const chosenPurchaseIdFromLocation = (
    ...
    setExtendedPurchases((prev) => {
      ...
      return (
        purchasesInCart?.map((purchase) => {
          const isChosenPurchaseFromLocation =
            chosenPurchaseIdFromLocation === purchase._id
          return {
            ...purchase,
            disabled: false,
            checked:
      ...
      <div className='container'>
        {extendedPurchases.length > 0 ? (
          <Fragment>
            ...
            <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-200 bg-white p-5 shadow sm:flex-row sm:items-center'>
              <div className='flex items-center'>
                ...
                <button
                  className='mx-3 border-none bg-none capitalize'
                ...
                <div>
                  <div className='flex items-center sm:justify-end'>
                    ...
                    <div className='ml-2 text-2xl text-orange'>
                      ₫{totalCheckedPurchasesPrice}
                    </div>
                  </div>
                  <div className='flex items-center text-sm sm:justify-end'>
                    <div className='text-gray-500'>Tiết kiệm</div>
                    <div className='ml-6 text-orange'>
                      ₫{totalCheckedPurchasesSavingPrice}
                    </div>
                  </div>
                </div>
                <Button
          ...
          <div className='text-center'>
            ...
            <div className='my-5 font-bold text-gray-500'>
              Giỏ hàng của bạn còn trống
            </div>
            <Link
              to={path.home}
              className='transition-al rounded-md bg-orange px-10 py-2 uppercase text-white hover:bg-orange/80'
            >
              Mua ngay
            </Link>
          </div>
