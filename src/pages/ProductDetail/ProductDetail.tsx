          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button
                  className='absolute left-0 top-1/2 z-10 h-9 w-5 -translate-y-1/2 bg-black/10 text-white'
                  onClick={prevImages}
                >
                  <svg
                ...
                <button
                  className='absolute right-0 top-1/2 z-10 h-9 w-5 -translate-y-1/2 bg-black/10 text-white'
                  onClick={nextImages}
                >
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
