    ...
    <div className='bg-gray-300/40 px-3 py-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button
            className={classNames('h-8  px-5 text-center text-sm capitalize ', {
          ...
          <select
            className={classNames(
              'h-8 px-3 text-left text-sm capitalize outline-none',
              {
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2 flex items-center justify-center'>
            {page === 1 ? (
              <span className='flex h-8 w-8 cursor-not-allowed items-center justify-center rounded-bl-sm rounded-tl-sm bg-white/60 px-3 hover:bg-slate-100'>
                <svg
              ...
              <Link
                ...
                className='flex h-8 w-8 cursor-pointer items-center justify-center rounded-bl-sm rounded-tl-sm bg-white px-3 hover:bg-slate-100'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
